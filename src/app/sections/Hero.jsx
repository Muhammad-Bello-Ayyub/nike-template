  ...
  return (
    <section className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container p-2">
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[45px] max-sm:leading-8 font-bold">
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-cover bg-center" style={{ backgroundImage: `url('/assets/images/collection-background.png')` }}>
        <Image
          src={bigShoeImg}
          alt="shoe collection"
          width={550}
